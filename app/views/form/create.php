        ...
        <div class="order">
            <form class="order_form" method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="data[worker_id]" id="worker_id">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="data[department_id]" onchange="setSalaryProduced()" id="department_id">
                            <? foreach($departments as $department): ?>
                                <option data-id="<?= $department['production_price'] ?>" value="<?= $department['id'] ?>">
